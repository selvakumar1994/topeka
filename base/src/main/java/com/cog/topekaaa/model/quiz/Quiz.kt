...
package com.cog.topekaaa.model.quiz

/**
 * This abstract class provides general structure for quizzes.

 * @see com.google.samples.apps.topekaaa.model.quiz.QuizType

 * @see com.google.samples.apps.topekaaa.widget.quiz.AbsQuizView
 */
