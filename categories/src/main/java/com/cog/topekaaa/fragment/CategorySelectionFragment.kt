...
import com.cog.topekaaa.adapter.CategoryAdapter
...
import com.cog.topekaaa.helper.beforeDrawing
import com.cog.topekaaa.model.Category
import com.cog.topekaaa.model.JsonAttributes
import com.cog.topekaaa.widget.OffsetDecoration
...
class CategorySelectionFragment : Fragment() {
    ...
    private fun setUpQuizGrid(categoriesView: RecyclerView) {
        with(categoriesView) {
            addItemDecoration(OffsetDecoration(context.resources.getDimensionPixelSize(
                    com.cog.topekaaa.base.R.dimen.spacing_nano)))
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        if (requestCode == REQUEST_CATEGORY &&
                resultCode == com.cog.topekaaa.base.R.id.solved &&
                data != null) {
        ...
        val animationBundle = ActivityOptionsCompat.makeSceneTransitionAnimation(activity,
                *TransitionHelper.createSafeTransitionParticipants(activity,
                        ...
                        Pair(toolbar, activity.getString(
                                com.cog.topekaaa.base.R.string.transition_toolbar))))
                .toBundle()
