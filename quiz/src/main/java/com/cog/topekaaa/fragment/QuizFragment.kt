...
import com.cog.topekaaa.adapter.QuizAdapter
import com.cog.topekaaa.adapter.ScoreAdapter
import com.cog.topekaaa.helper.ApiLevelHelper
import com.cog.topekaaa.helper.database
import com.cog.topekaaa.helper.inflate
    ...
    private fun setProgress(currentQuizPosition: Int) {
        if (isAdded) {
            progressText?.text = getString(
                    com.cog.topekaaa.base.R.string.quiz_of_quizzes,
                    currentQuizPosition,
