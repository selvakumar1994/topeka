...
class ScoreAdapter(private val context: Context, private val category: Category) : BaseAdapter() {
    ...
    private val successIcon by lazy {
        loadAndTint(
                com.cog.topekaaa.base.R.drawable.ic_tick,
                com.cog.topekaaa.base.R.color.theme_green_primary)
    }
    private val failedIcon by lazy {
        loadAndTint(com.cog.topekaaa.base.R.drawable.ic_cross,
                com.cog.topekaaa.base.R.color.theme_red_primary)
    }
