...
package com.cog.topekaaa.widget.quiz
...
import com.cog.topekaaa.activity.QuizActivity
import com.cog.topekaaa.helper.ApiLevelHelper
import com.cog.topekaaa.helper.FOREGROUND_COLOR
import com.cog.topekaaa.helper.onLayoutChange
import com.cog.topekaaa.model.Category
import com.cog.topekaaa.model.quiz.Quiz
import com.cog.topekaaa.quiz.R
import com.cog.topekaaa.widget.fab.CheckableFab

const val KEY_ANSWER = "answer"

/**
 * This is the base class for displaying a [com.google.samples.apps.topekaaa.model.quiz.Quiz].
 *
 *
 ...
 * @param <Q> The type of [com.google.samples.apps.topekaaa.model.quiz.Quiz] you want to
 * display.
</Q> */
...
(context: Context, private val category: Category, val quiz: Q) : FrameLayout(context) {
    ...
    init {
        ...
        quizContentView = createQuizContentView()?.apply {
            id = com.cog.topekaaa.base.R.id.quiz_content
            isSaveEnabled = true
    ...
    private val doubleSpacing = resources.getDimensionPixelSize(
            com.cog.topekaaa.base.R.dimen.spacing_double)
    ...
    private fun createContainerLayout(context: Context): LinearLayout {
        return LinearLayout(context).apply {
            id = com.cog.topekaaa.base.R.id.absQuizViewContainer
    ...
    private fun addFloatingActionButton() {
        val fabSize = resources.getDimensionPixelSize(
                com.cog.topekaaa.base.R.dimen.size_fab)
     ...
     * [com.google.samples.apps.topekaaa.model.quiz.Quiz] they want to display.
    ...
    private fun performScoreAnimation(answerCorrect: Boolean) {
        ...
        val backgroundColor = ContextCompat.getColor(context,
                if (answerCorrect) com.cog.topekaaa.base.R.color.green
                else com.cog.topekaaa.base.R.color.red)
    ...
    private fun setMinHeightInternal(view: View) {
        view.minimumHeight = resources.getDimensionPixelSize(
                com.cog.topekaaa.base.R.dimen.min_height_question)
    }
